...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_EQUAL,                                       KC_PSCR,        KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       
    ...
    CW_TOGG,        KC_TRANSPARENT, LCTL(KC_A),     LALT(KC_A),     MT(MOD_LALT, KC_TAB),OSM(MOD_HYPR),                                                                                                  OSM(MOD_MEH),   MT(MOD_LALT, KC_ESCAPE),KC_MAC_COPY,    KC_MAC_PASTE,   KC_DELETE,      TD(DANCE_2),    
    KC_SPACE,       LT(2,KC_ENTER), TT(4),                          TT(7),          LT(3,KC_ESCAPE),KC_BSPC
  ),
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_PC_COPY,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_MEH),                                                                                                   OSM(MOD_HYPR),  KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_PC_PASTE,    TD(DANCE_3),    
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_NO,          LALT(LGUI(LCTL(LSFT(KC_W)))),CW_TOGG,        KC_NO,          KC_PSCR,        KC_NO,          KC_NO,                                          KC_NO,          LGUI(KC_R),     KC_MAC_UNDO,    KC_MAC_COPY,    KC_MAC_CUT,     KC_MAC_PASTE,   KC_NO,          
    ...
    KC_NO,          LCTL(KC_A),     KC_NO,          OSM(MOD_HYPR),  OSM(MOD_MEH),   KC_NO,                                          LALT(KC_LEFT),  LGUI(KC_LEFT),  LGUI(KC_RIGHT), LALT(KC_RIGHT), LALT(KC_A),     KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,                                                                                                          KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_NO,          KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,                          KC_NO,          MO(4),          KC_NO
  ),
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,        KC_PLUS,                                        KC_EQUAL,       KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RPRN,        KC_TRANSPARENT, 
    KC_BSLS,        KC_AMPR,        KC_PERC,        KC_LBRC,        KC_RBRC,        KC_TILD,        KC_COLN,                                        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, 
    KC_ASTR,        KC_LCBR,        KC_RCBR,        KC_LPRN,        KC_RPRN,        KC_EQUAL,       KC_HASH,                                                                        QK_LLCK,        KC_NO,          KC_LEFT_SHIFT,  KC_LEFT_GUI,    KC_LEFT_CTRL,   KC_LEFT_ALT,    KC_TRANSPARENT, 
    KC_AT,          KC_PIPE,        KC_EXLM,        KC_LABK,        KC_RABK,        KC_PLUS,                                        KC_NO,          KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_HYPR,        
    KC_UNDS,        KC_HASH,        KC_DLR,         KC_CIRC,        KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_NO,          
    KC_TRANSPARENT, MO(4),          KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_moonlander(
  ...
  [6] = LAYOUT_moonlander(
    ...
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, KC_NO,          
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_moonlander(
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [2] = { {208,139,255}, {0,0,255}, {208,139,255}, {0,0,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {208,139,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {208,139,255}, {0,0,255}, {208,139,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {208,139,255}, {208,139,255}, {208,139,255}, {0,0,255}, {0,0,255}, {247,218,204}, {0,0,255}, {208,139,255}, {0,0,255}, {0,0,255} },

    [3] = { {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {0,0,255}, {187,244,255}, {0,0,255}, {0,0,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {0,0,255}, {187,244,255}, {0,0,255}, {187,244,255}, {187,244,255}, {0,0,255}, {187,244,255}, {0,0,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {0,0,255}, {187,244,255}, {187,244,255}, {187,244,255}, {187,244,255}, {0,0,255}, {187,244,255}, {0,0,255}, {187,244,255}, {187,244,255}, {0,0,255}, {0,0,255}, {0,0,255}, {187,244,255}, {0,0,255}, {247,218,204}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255} },
